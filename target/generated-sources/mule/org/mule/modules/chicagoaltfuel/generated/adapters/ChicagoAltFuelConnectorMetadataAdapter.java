...
/**
 * A <code>ChicagoAltFuelConnectorMetadataAdapter</code> is a wrapper around {@link ChicagoAltFuelConnector } that adds support for querying metadata about the extension.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-10-02T10:28:00-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class ChicagoAltFuelConnectorMetadataAdapter
    extends ChicagoAltFuelConnectorCapabilitiesAdapter
    implements MetadataAware
{

    private final static String MODULE_NAME = "ChicagoAltFuel";
