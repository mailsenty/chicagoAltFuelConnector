...
public class FindOnFuelTypeMessageProcessorDebuggable
    extends FindOnFuelTypeMessageProcessor
    implements DebugInfoProvider
{


    public FindOnFuelTypeMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("fuel_type_code", "Fuel_type_code", (java.lang.String.class), fuel_type_code, muleEvent));
